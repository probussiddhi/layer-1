...
def extract_text_from_pdf_tw(pdf_file):
    ...
    """
    # If pdf_file is a path, open it as a file; if it's BytesIO, handle it as a stream
...
def extract_data_from_pdf_tw(pdf_file):
    """
    Extract complete data from the PDF for Zuno two-wheeler insurance.
    """
    try:
